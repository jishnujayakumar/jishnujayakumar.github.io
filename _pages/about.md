...
My research asks how little supervision a real robot actually needs. Embodied systems are typically built from massive labeled datasets or hours of teleoperation; with a strong pretrained backbone underneath, much smaller forms of supervision often suffice &mdash; a handful of exemplar images, a single human demonstration video, or a few minutes of in-situ correction. My thesis, *Learning from Humans and Few Examples for Embodied Robotics*, builds datasets, algorithms, and an evaluation methodology around this regime, all tested on physical hardware.
